...
\newcommand{\documentTitle}{Smart IoT-Integrated Waste Management: Advanced E-Waste Dataset Creation, Real-Time MobileNet Classification, and Optimized Collection Scheduling} % put tilde (~) between words to indicate non-breaking adjacent words
