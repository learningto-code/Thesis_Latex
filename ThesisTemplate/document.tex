...
\newcommand{\documentTitle}{An IoT-Enabled System for Real-Time Fuel Monitoring, GPS Tracking, and Anomaly Detection in Trucks Using Non-Parametric Unsupervised Machine Learning} % put tilde (~) between words to indicate non-breaking adjacent words

\newcommand{\keywords}{Fuel Monitoring, GPS Tracking, Anomaly Detection, Internet of Things, Unsupervised Machine Learning, Isolation Forest, Matrix Profile}
